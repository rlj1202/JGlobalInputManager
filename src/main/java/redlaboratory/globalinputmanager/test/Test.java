...
//				case GlobalKeyboardEvent.VK_E: case GlobalKeyboardEvent.VK_X: case GlobalKeyboardEvent.VK_I: case GlobalKeyboardEvent.VK_T:
//					case GlobalKeyboardEvent.VK_ENTER: case GlobalKeyboardEvent.VK_BACK:
//					break;
//				default:
...
//				}
			...
			public void mouseWheelScroll(GlobalMouseEvent event) {
				System.out.println("	mouse wheel scroll: " + event.getX() + ", " + event.getY() + ", " + event.getDelta());
			}
